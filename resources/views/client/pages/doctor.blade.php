...
@section("front-content")
                    ...
                    <ul class="splide__list">
                        <li class="splide__slide">
                            <div class="card p-2" style="width: 18rem;">
                                <img src="{{ asset("client/assets/images/major.jpg") }}" class="card-img-top rounded-circle card-image-circle"
                                    alt="major">
                                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                    <h4 class="card-title fw-bold text-center">Doctor Name</h4>
                                    <h6 class="card-title fw-bold text-center">Major</h6>
                                    <a href="{{ route('bookappoument') }}" class="btn btn-outline-primary card-button">Book an
                                        appointment</a>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="splide__slide">
                            <div class="card p-2" style="width: 18rem;">
                                ...
                                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                    <h4 class="card-title fw-bold text-center">Doctor Name</h4>
                                    <h6 class="card-title fw-bold text-center">Major</h6>
                                    <a href="{{ route('bookappoument')  }} " class="btn btn-outline-primary card-button">Browse
                                        Doctors</a>
                                </div>
                            </div>
                        </li>
        ...
        <div class="banner container d-block d-lg-grid d-md-block d-sm-block">
            ...
            <div class="bottom--right bg-blue text-white">
                <img src="{{ asset("client/assets/images/banner.jpg") }}" class="img-fluid banner-img">
            </div>
        </div>
@endsection
